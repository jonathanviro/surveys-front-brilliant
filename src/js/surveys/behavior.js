import { palabrasComportamientos } from '../helpers/palabrasComportamientos.js';
import { postComportamientosRespuestas } from '../api.js';
...
document.getElementById("list").innerHTML = palabrasComportamientos.map(questionGroup).join(" ");
...
document.getElementById("submit-btn").addEventListener("click", async () => {
    ...
    try {
        const result = await postComportamientosRespuestas(respuestas);
